...
public class DeDupTest {
    ...
    private String copy(InputStream in, int count, String prefix, Collection<File> capture) throws IOException, NoSuchAlgorithmException {
    ...
    public void testMain() throws Exception {
        ...
        Map<Boolean, List<File>> results = dedup.execute();
